...
copyright = u'''2009-2013,Open Knowledge Foundation.
    Licensed under Creative Commons Attribution ShareAlike (Unported) v3.0 License'''
...
html_theme_options = {
        ...
        'textcolor': '#444444',
        'linkcolor': '#0d4252',
        'visitedlinkcolor': '#0d4252',

        'relbarbgcolor': '#003647',
        'relbartextcolor': '#ffffff',
        'relbarlinkcolor': '#ffffff',

        'footerbgcolor': '#003647',
        'footertextcolor': '#ffffff',

        'sidebarbgcolor': '#005d7a',
...
html_style = '/default.css'  # Use the Sphinx default theme (not the Read The Docs one)
